...
namespace Drupal\test_delete_field;
...
/**
 * Implements custom permissions for test_delete_field fields.
 */
class FieldPermissions implements ContainerInjectionInterface {
  ...
  public function permissions() {
    $map = $this->fieldManager->getFieldMapByFieldType('field_to_be_deleted');
    $perms = [];
